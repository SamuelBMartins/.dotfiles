...
hl.workspace_rule({ workspace = "7", monitor = "desc:Samsung Electric Company S24C300 0x30333138", default = true, persistent = true })
...
hl.workspace_rule({ workspace = "10", monitor = "desc:Samsung Electric Company S24C300 0x30333138" })
